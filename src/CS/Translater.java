...
public class Translater {
	...
	private static Translater baidu;

	static {
		ApplicationContext container = new FileSystemXmlApplicationContext(
				"./baidu.xml");
		baidu = (Translater) container.getBean("baidu");
	}
	...
	public String translateToEn(String q) throws Exception {
	...
	public String translateToZh(String q) throws Exception {
